...
//	} };
	...
	public String RegisterRetailer(String user_type,String username, String password, String email, String shop_name, String shop_address, String states_id, String city_id, String hp_no, String birth_date, String distribution_name, String owner_name, String id_no, String id_no_type){
		try {
			String url = apiurl+"users/create";
			String params = "user_type="+ URLEncoder.encode(user_type, "UTF-8")+" username="+ URLEncoder.encode( username, "UTF-8")+ "&password="+ URLEncoder.encode(password, "UTF-8")
